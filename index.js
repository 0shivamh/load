...
const API_ENDPOINTS = [
  // "https://api.myverimed.cwipedia.com/myverimed/login"
    ...
    // 'https://apiv2.bigbooster.in/home', // Replace with your API endpoint 1
    'https://htest.bigbooster.in/select', // Replace with your API endpoint 2
  ...
  const CONCURRENCY_LEVEL = 500; // Number of concurrent requests per endpoint
